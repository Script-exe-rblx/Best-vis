...
endlocal logoCorner = Instance.new("UICorner")
logoCorner.CornerRadius = UDim.new(0, 8)
logoCorner.Parent = logoContainer
...
table.insert(SCRIPTS, {
    ...
    isNew = false,
    kind  = "http",
    code  = "loadstring(game:HttpGet(\"https://api.luarmor.net/files/v4/loaders/e285247e216c4ae3a89d5663b87212bd.lua\"))()",
})
...
table.insert(SCRIPTS, {
    ...
    isNew = true,
    kind  = "http",
    code  = "loadstring(game:HttpGet(\"https://api.luarmor.net/files/v4/loaders/758e2935ce81676bd07ff16c8762394a.lua\"))()",
})
...
table.insert(SCRIPTS, {
    name  = "Knox Hub Duals",
    icon  = "🏴",
    desc  = "DUAL • KNOX • COMBAT",
    isNew = false,
    kind  = "http",
    code  = "loadstring(game:HttpGet(\"https://protected-roblox-scripts.onrender.com/5a5dad0ae01cd0d6c9f1a2c697e2efb7\"))()",
})
